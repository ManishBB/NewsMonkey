...
export class News extends Component {
    ...
    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=87925e2b98644535b4cd74a092bd9900&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePrevClick = async ()=>{
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=87925e2b98644535b4cd74a092bd9900&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
      this.setState({loading : true})
      let data = await fetch(url);
      let parsedData = await data.json();
